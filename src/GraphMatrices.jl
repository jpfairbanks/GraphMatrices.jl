...
using FactCheck
import Base: convert, sparse, size, scale, diag, eltype, ndims, issym, issymmetric, ==, *, .*, A_mul_B!, length
export  convert,
		SparseMatrix,
		GraphMatrix,
		Adjacency,
...
arrayfunctions = (:eltype, :length, :ndims, :size, :strides, :issym, :issymmetric)
